...
@NgModule({
  ...
  exports: [
    ...
    FeaturesComponent, 
    ClientComponent, 
    PortfolioComponent, PricingComponent, 
    ContactComponent, FooterComponent, FeatherModule, 
    ScrollspyDirective, Services2Component, 
    Features2Component, Client2Component, FaqComponent, 
    Pricing2Component,
  ]
})
